...
/**
 * Created by yuehu on 8/14/20.
 */
public class DictionaryWord {
    public boolean carBreak(String input, String[] dict) {
        // Assumptions:
        ...
        // canBreak[i] represents index (i-1) in input, also can represent the substring(0,i)
